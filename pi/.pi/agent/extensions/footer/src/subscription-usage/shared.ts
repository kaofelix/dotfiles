...
export const PROVIDERS = ["anthropic", "copilot", "gemini", "antigravity", "codex", "kimi", "kiro", "zai"] as const;
...
export const PROVIDER_METADATA: Record<ProviderName, ProviderMetadata> = {
	...
	kimi: {
		...
		detection: {
			providerTokens: ["kimi-coding", "kimi"],
			modelTokens: ["kimi-for-coding"],
		},
	},
	kiro: {
